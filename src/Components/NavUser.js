                ...
                <div className="container-fluid" style={{height: "80px"}}>
                    ...
                    <div className={`navbar-menu ${this.state.mostrarMenu ? "is-active" : ""}`}>
                        <div className="navbar-start">
                            ...
                            {/*<a onClick={this.ocultarMenu} activeclassname="is-active" className="navbar-item" href="/CrearJuegos"> Crear Juegos 🕵</a>
                            <a onClick={this.ocultarMenu} activeclassname="is-active" className="navbar-item" href="/VerJuegos"> Ver Juegos 🕵</a>
                            */}
